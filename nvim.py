...
class Nvim(object):
    ...
    def __init__(self, output, **kwargs):
        ...
        self._general_setting = {
                ...
                "command_col": kwargs.get(
                    "GeneralSettings:command_col",
                    "Command"
                ),
                "description_col": kwargs.get(
                    "GeneralSettings:description_col",
                    "Description"
                )
            }
        self._plugins = {
        ...
        with open(self._document_file, "r") as file_descriptor:
            self._lines = file_descriptor.readlines()
